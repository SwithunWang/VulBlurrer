...
CUDA_VISIBLE_DEVICES=0 python run.py \
    ...
    --model_type=roberta \
    --tokenizer_name=/home/feara6/Downloads/JOS_baseline/CodeTAE-main/CodeBERT/Defect-detection/code/models/CodeBert-base \
    --model_name_or_path=/home/feara6/Downloads/JOS_baseline/CodeTAE-main/CodeBERT/Defect-detection/code/models/CodeBert-base \
    --do_train \
...
attack
CUDA_VISIBLE_DEVICES=0 python3 attack_ablation_ensemble.py \
    --output_dir=./saved_models \
    --model_type=roberta \
    --tokenizer_name=\
    --model_name_or_path=\

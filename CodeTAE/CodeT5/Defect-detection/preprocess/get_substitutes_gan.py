...
class GeneticAlgorithm():
    ...
    def __init__(self, initial_population,):
        ...
        self.initial_population = initial_populationhome/hu
        self.model_sub = T5ForConditionalGeneration.from_pretrained("").to(self.device)
...
def main():
    ...
    with open(args.store_path, "w") as wf:
        ...
        sampled_subs_set = random.sample(list(all_substitutes_set), round(len(all_substitutes_set)/10))

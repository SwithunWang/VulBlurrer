...
def main():
    ...
    if args.model_name_or_path:
        model_tgt = model_class.from_pretrained('')
    else:
    ...
    model_sub = T5ForConditionalGeneration.from_pretrained('').to(args.device)
    ...
    with open(args.eval_data_file) as f:
        for line in f:
            ...
            idx = js.get('idx', len(idx_group))  # 获取索引，如果没有则使用当前位置
    ...
    for index, example in enumerate(test_dataset):
        ...
        idx_now = idx_group[index]  # 获取当前索引

        ...
        with open(file_path) as f:
            ...
            for line in f:
                ...
                try:
                    ...
                    logger.warning(f"Skip invalid JSON line in {file_path}: {line[:80]}...")
                    continue
                self.examples.append(convert_examples_to_features(js, tokenizer, args))
...
def test(args, model, tokenizer):
    ...
    # output_dir = os.path.join(args.output_dir, '{}'.format(checkpoint_prefix))
    # output_dir = "../big_vul_examples/codebert_bigvul/checkpoint-best-acc/model.bin"

    output_dir = model_path + "_bigvul/checkpoint-best-acc/model.bin"
    ...
    for batch in eval_dataloader:
        ...
        with torch.no_grad():
            ...
            labels.append(label.cpu().numpy())
    if len(logits) == 0:
        print("Warning: no valid samples for testing.")
        error_flag = 'no_valid_samples'
        results = {
            "eval_acc": 0.0,
            "eval_acc_revalidate": 0.0,
            "precision": 0.0,
            "recall": 0.0,
            "f1": 0.0,
            "labels": [],
    ...
    predictions_dir = "/home/guan1103/0.code/RobustnessAttackVD-main/Defect-detection_using_ICSE2022_CodeBert/results/run_robustness_attackV2_test_predictions.txt"
...
def main(training=False, evaluating=False,
         ...
         target_model_path="../models/codebert"
         ):
    global model_path
    model_path = target_model_path
    # model_path = "/home/guan1103/0.code/RobustnessAttackVD-main/Defect-detection_using_ICSE2022_CodeBert/models/graphcodebert-base"
    ...
    parser.add_argument("--config_name", default=model_path, type=str,
